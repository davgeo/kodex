...
urlpatterns = [
    ...
    url(r'^kodi.*?_setserver_([0-9]+)$', views.setserver, name='setserver'),
    url(r'^kodi/addserver$', views.addserver, name='addserver'), # POST
    url(r'^kodi/removeserver$', views.removeserver, name='removeserver'), # POST
    url(r'^kodi/pingserver_([0-9]+)$', views.pingserver, name='pingserver'),
    ...
    url(r'^kodi/([0-9]+)/tv/([0-9]+)_starred$', views.starredtvshow, name='starredtvshow'),
    ...
    url(r'^kodi/([0-9]+)/movies/([0-9]+)_watched$', views.watchedmovie, name='watchedmovie'),
    url(r'^kodi/([0-9]+)/movies/([0-9]+)_starred', views.starredmovie, name='starredmovie'),
    url(r'^kodi/([0-9]+)/movies/([0-9]+)_remove$', views.removemovie, name='removemovie'),
    ...
    url(r'^kodi/([0-9]+).*?_togglesubtitles$', views.togglesubtitles, name='togglesubtitles'),
    url(r'^kodi/([0-9]+).*?_cyclesubtitles$', views.cyclesubtitles, name='cyclesubtitles'),
    ...
    url(r'^kodi/([0-9]+).*?_setvolume$', views.setvolume, name='setvolume'), # GET
    url(r'^kodi/([0-9]+).*?_setprogress_([0-9]+)$', views.setprogress, name='setprogress'),
    url(r'^kodi/([0-9]+).*?_getstatus$', views.getstatus, name='getstatus'),
    url(r'^kodi/([0-9]+).*?_getplaylist$', views.getplaylist, name='getplaylist'),
]
